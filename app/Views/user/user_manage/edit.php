            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="username" id="username" placeholder="Masukan Username"
                        required value="<?= isset($data['username']) ? $data['username'] : '' ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="status" id="status">
                        ...
                        <option <?= isset($data['status']) && $data['status'] == 'aktif' ? 'selected' : '' ?>>Aktif
                        </option>
                        <option <?= isset($data['status']) && $data['status'] == 'non-aktif' ? 'selected' : '' ?>>
                            Non-Aktif</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control" name="role" id="role">
                        ...
                        <option value="<?= $value->id; ?>"
                            <?= isset($data['role_id']) && $data['role_id'] == $value->id ? 'selected' : ''; ?>>
                            <?= $value->role; ?></option>
                        <?php } ?>
                    </select>
                </div>
