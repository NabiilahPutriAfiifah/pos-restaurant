            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select name="tipe" id="tipe" class="form-control">
                        <option value="umum" <?= isset($data['tipe']) && $data['tipe'] == "umum" ? 'selected' : ''; ?>>
                            Umum</option>
                        <option value="member"
                            <?= isset($data['tipe']) && $data['tipe'] == "member" ? 'selected' : ''; ?>>Membership
                        </option>
                    </select>
                </div>
                <div class="form-group">
