        ...
        <div class="card">
            ...
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php if(count(esc($penjualan)) > 0){
                            $i = 1;
                    ?>
                        <?php foreach(esc($penjualan) as $t) : ?>
                        <tr>
                            <td><?= $i++; ?></td>
                            <td><?= esc($t->tanggal_penjualan) ?></td>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="<?= base_url('penjualan/cetak/'.$t->id) ?>"
                                        class="btn btn-primary text-light rounded mx-1" title="Print Invoice">
