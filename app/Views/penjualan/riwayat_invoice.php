...
<body onload="print()">
    <div class="container">
        ...
        <div class="head">
            <table class="table">
                <tr>
                    <td class="kiri"><?= $penjualan['tanggal_penjualan'] ?></td>
                    <td class="kanan"> Kasir :</td>
                    <td class="kanan"><?= $penjualan['nama_kasir'] ?></td>
                </tr>
            </table>
        </div>
        <div class="transaksi">
            <table class="table">
                ...
                <td id="total" class="kanan">Total Akhir : <?= 'Rp '.number_format($d->total_harga, 0 , ',', '.') ?>
                </td>
                </tr>
                <?php endforeach; ?>
                <tr>
                ...
                <tr>
                    ...
                    <td class="kanan">Rp. <?= number_format($penjualan['sub_total'], 0, ',', '.') ?></td>
                </tr>
                <tr>
                    <td colspan="2"></td>
                ...
                <tr>
                    ...
                    <td class="kanan"><?= $penjualan['diskon'] ?> % </td>
                </tr>
                <tr>
                    <td colspan="4" class="kanan">Total Akhir</td>
                    <td class="kanan">Rp. <?= number_format($penjualan['total_akhir'], 0, ',', '.') ?></td>
                </tr>
                <tr>
                    <td colspan="2"></td>
                    <td colspan="3" style="border-bottom: 1px dashed;"></td>
                ...
                <tr>
                    ...
                    <td class="kanan">Rp. <?= number_format($penjualan['tunai'], 0, ',', '.') ?></td>
                </tr>
                <tr>
                    <td colspan="4" class="kanan">Kembalian</td>
                    <td class="kanan">Rp. <?= number_format($penjualan['kembalian'], 0, ',', '.') ?></td>
                </tr>
            </table>
        </div>
