...
class User extends BaseController{
    ...
    public function update_user($id=''){
        ...
        if(empty($id)){
            return redirect()->to('user/user_manage')->with('error', 'Data Tidak di Temukan');
        }
    ...
    public function submit_changes_user(){
        ...
        if($save){
            return redirect()->to('user/user_manage')->with('success', 'Data Berhasil di Tambahkan');
        } else {
            return redirect()->to('user/user_manage')->with('error', 'Data Tidak di Temukan');
        }
    }
    ...
    public function save_changes_user($id=''){
        ...
        if($save){
            return redirect()->to('user/user_manage')->with('success', 'Data Berhasil di Ubah');
        } else {
            return redirect()->to('user/user_manage')->with('error', 'Data Tidak di Temukan');
        }
    }
